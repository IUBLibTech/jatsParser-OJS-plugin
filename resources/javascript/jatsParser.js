// Reset book under review above authors
(function () {
	var divTopRelated = document.getElementById('jatsParser__related-object');
	var divRelatedOjb = document.getElementById('related-object');
	var divRefTitle = document.getElementById('reference-title');
	var parentContainer = document.getElementById('jatsParserFullText');
	if (divTopRelated) {
		divTopRelated.appendChild(divRelatedOjb);
		parentContainer.removeChild(divRefTitle);
		}
})();
